...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("0c726da1-805d-4d8e-9e3e-3be7db9c6df5", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'pbs_webSite'.", repo.pbs_webSite.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.pbs_webSite.Self, new Duration(0));
