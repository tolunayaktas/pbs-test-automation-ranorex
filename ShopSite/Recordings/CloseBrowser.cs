...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("c7f7e774-c251-41dd-bd36-78c880d14772", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'pbs_shopSite'.", repo.pbs_shopSite.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.pbs_shopSite.Self, new Duration(0));
